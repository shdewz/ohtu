...
class TestKauppa(unittest.TestCase):
    ...
    def test_kaksi_eri_ostosta_tilisiirto_oikeilla_arvoilla(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
            if tuote_id == 2:
    ...
    def test_kaksi_samaa_ostosta_tilisiirto_oikeilla_arvoilla(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
    ...
    def test_kaksi_eri_ostosta_toinen_loppu_tilisiirto_oikeilla_arvoilla(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
            if tuote_id == 2:
    ...
    def test_viitenumero_juoksee(self):
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
        ...
        self.pankki_mock.tilisiirto.assert_called_with("pekka", 3, "12345", ANY, 10)
